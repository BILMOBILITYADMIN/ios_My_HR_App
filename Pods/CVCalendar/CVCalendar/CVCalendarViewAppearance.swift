...
public final class CVCalendarViewAppearance: NSObject {
    ...
    public var dayLabelWeekdayFont: UIFont? = UIFont.systemFontOfSize(16)
    public var dayLabelPresentWeekdayFont: UIFont? = UIFont.systemFontOfSize(16)
    public var dayLabelPresentWeekdayBoldFont: UIFont? = UIFont.systemFontOfSize(16)
    public var dayLabelPresentWeekdayHighlightedFont: UIFont? = UIFont.systemFontOfSize(16)
    public var dayLabelPresentWeekdaySelectedFont: UIFont? = UIFont.systemFontOfSize(16)
    public var dayLabelWeekdayHighlightedFont: UIFont? = UIFont.systemFontOfSize(16)
    public var dayLabelWeekdaySelectedFont: UIFont? = UIFont.systemFontOfSize(16)
    
    /// Default text color.
    public var dayLabelWeekdayInTextColor: UIColor? = .blackColor()
    public var dayLabelWeekdayOutTextColor: UIColor? = .grayColor()
    public var dayLabelWeekdayHighlightedTextColor: UIColor? = .blackColor()
    public var dayLabelWeekdaySelectedTextColor: UIColor? = .blackColor()
    ...
    public var dayLabelPresentWeekdaySelectedTextColor: UIColor? = .redColor()
